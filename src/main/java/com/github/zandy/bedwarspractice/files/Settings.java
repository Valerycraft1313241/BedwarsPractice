...
public class Settings extends BambooFile {
    ...
    private Settings() {
        super("Settings");
        Arrays.stream(Settings.SettingsEnum.values()).forEach((setting) -> this.addDefault(setting.getPath(), setting.getDefaultValue()));
        this.copyDefaults();
        this.save();
    }
    ...
    public enum SettingsEnum {
        ...
        public List<Material> getMaterials() {
            ...
            Settings.getInstance().getStringList(this.path).forEach((materialName) -> materials.add(Material.valueOf(materialName)));
            return materials;
        }
